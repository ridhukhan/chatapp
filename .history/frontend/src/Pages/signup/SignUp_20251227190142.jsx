...
<div>
<button disabled={loading} className=' px-6 py-1  rounded btn btn-block btn-sm mt-2 border border-slate-700 bg-blue-500' > {loading ? <span className="loading loading-spinner"></span> : "Sign Up"}</button>
</div>
